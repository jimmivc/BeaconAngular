...
angular.module('myApp.beaconFinder', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  	$routeProvider.when('/beaconFinder', {
    templateUrl: 'beaconFinder/beaconFinder.html',
    controller: 'BeaconFinderCtrl'
  });
}])

.controller('BeaconFinderCtrl', [function() {
	...
	// });
	// 'F1:A5:A6:CF:98:BC'
	var beaconsIdsList = ['E1:0D:88:DA:70:BA'];
	var beaconDistance = 10;

	var beaconHot = 10.0;
	var beaconWarm = 20.0;
	var beaconArround = 40.0;
